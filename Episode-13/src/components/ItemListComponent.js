...
const ItemListComponent = ({items,dummy})=>{
    ...
    //dispatch function is used to dispatch an action to the redux store.
    //given by react-redux library.
    ...
    return(
           <div>
            {items.map((e)=>(
                ...
                key={e.item.id}  className="p-2 m-2  border-gray-200 border-b-2 text-left flex justify-between" >
